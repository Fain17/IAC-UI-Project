...
from app.services.workflow_service import create_workflow, get_user_workflows, get_workflow_by_id, delete_workflow, update_workflow, execute_workflow, get_execution_status, get_workflow_executions
from app.auth.dependencies import get_current_user
from app.db.models import WorkflowCreate, WorkflowUpdate, ScriptExecutionRequest
...
async def upload_script_route(
    ...
    Supports: .sh, .yml, .tf, .py files
    """
    try:
        import json
        
        # Validate script type
        if script_type not in ["sh", "playbook", "terraform", "aws"]:
